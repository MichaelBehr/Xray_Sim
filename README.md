...
* <a href="https://www.codecogs.com/eqnedit.php?latex=tan(\Theta&space;_{x})&space;=&space;\frac{x}{(Z_{DSO}&plus;z)}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?tan(\Theta&space;_{x})&space;=&space;\frac{x}{(Z_{DSO}&plus;z)}" title="tan(\Theta _{x}) = \frac{x}{(Z_{DSO}+z)}     (1)" /></a>
* <a href="https://www.codecogs.com/eqnedit.php?latex=tan(\Theta&space;_{y})&space;=&space;\frac{y}{(Z_{DSO}&plus;z)}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?tan(\Theta&space;_{y})&space;=&space;\frac{y}{(Z_{DSO}&plus;z)}" title="tan(\Theta _{y}) = \frac{y}{(Z_{DSO}+z)}     (2)" /></a>
2. The same angles, are related to the projected 2D points by the next equations:
* <a href="https://www.codecogs.com/eqnedit.php?latex=tan(\Theta&space;_{x})&space;=&space;\frac{X_{d}}{(Z_{DSD})}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?tan(\Theta&space;_{x})&space;=&space;\frac{X_{d}}{(Z_{DSD})}" title="tan(\Theta _{x}) = \frac{X_{d}}{(Z_{DSD})}     (3)" /></a>
* <a href="https://www.codecogs.com/eqnedit.php?latex=tan(\Theta&space;_{y})&space;=&space;\frac{Y_{d}}{(Z_{DSD})}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?tan(\Theta&space;_{y})&space;=&space;\frac{Y_{d}}{(Z_{DSD})}" title="tan(\Theta _{y}) = \frac{Y_{d}}{(Z_{DSD})}     (4)" /></a>
3. Sub equations (1) and (2) into (3) and (4) respectively, and solve for Xd and Yd respectively.
* <a href="https://www.codecogs.com/eqnedit.php?latex=\frac{x}{Z_{DSO}&plus;z}&space;=&space;\frac{X_{d}}{(Z_{DSD})}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{x}{Z_{DSO}&plus;z}&space;=&space;\frac{X_{d}}{(Z_{DSD})}" title="\frac{x}{Z_{DSO}+z} = \frac{X_{d}}{(Z_{DSD})}     (5)" /></a>

* <a href="https://www.codecogs.com/eqnedit.php?latex=X_{d}&space;=&space;x&space;\frac{Z_{DSD}}{Z_{DSO}&plus;z}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?X_{d}&space;=&space;x&space;\frac{Z_{DSD}}{Z_{DSO}&plus;z}" title="X_{d} = x \frac{Z_{DSD}}{Z_{DSO}+z}     (6)" /></a>

* <a href="https://www.codecogs.com/eqnedit.php?latex=\frac{y}{Z_{DSO}&plus;z}&space;=&space;\frac{Yd}{Z_{DSD}}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\frac{y}{Z_{DSO}&plus;z}&space;=&space;\frac{Yd}{Z_{DSD}}" title="\frac{y}{Z_{DSO}+z} = \frac{Yd}{Z_{DSD}}     (7)" /></a>

* <a href="https://www.codecogs.com/eqnedit.php?latex=Y_{d}&space;=&space;y&space;\frac{Z_{DSD}}{Z_{DSO}&plus;z}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?Y_{d}&space;=&space;y&space;\frac{Z_{DSD}}{Z_{DSO}&plus;z}" title="Y_{d} = y \frac{Z_{DSD}}{Z_{DSO}+z}     (8)" /></a>
